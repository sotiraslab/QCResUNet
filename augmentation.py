...
default_3D_augmentation_params = {
    ...
    "num_threads": 12 if 'nnUNet_n_proc_DA' not in os.environ else int(os.environ['nnUNet_n_proc_DA']),
    "num_cached_per_thread": 2,
    # "patch_size_for_spatialtransform": (160, 192, 160)
}
...
def get_moreDA_augmentation(dataloader_train, dataloader_val, patch_size, params=default_3D_augmentation_params,
                            ...
                            use_nondetMultiThreadedAugmenter: bool = True):
    ...
    tr_transforms.append(NumpyToTensor(['data', 'seg', 'target'], 'float'))
    ...
    val_transforms.append(NumpyToTensor(['data', 'seg', 'target'], 'float'))
